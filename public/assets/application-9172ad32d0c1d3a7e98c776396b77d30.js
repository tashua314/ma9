...
;
(function() {
  var Util, errorCallback, successCallback;

  successCallback = function(pos) {
    var latitude, longtitude;
    console.log("start successCallback.");
    latitude = pos.coords.latitude;
    return longtitude = pos.coords.longtitude;
  };
  ...
  Util = (function() {
    ...
    Util.getDetail = function(id, dataJson) {
      var error;
      try {
        console.log(id);
    ...
    Util.getLocation = function() {
      var a, error, geolocation, nowLocation;
  ...
  $(function() {
    ...
    console.log("have you lat?: " + (nowLocation['latitude'] != null));
    if (nowLocation['latitude'] == null) {
      return Util.getLocation();
    }
  });

  $('a').on('click', function() {
    return Util.getDetail($(this).attr('value'), dataJson);
  });
